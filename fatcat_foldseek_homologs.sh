### FATCAT comparison of list of proteins from Foldseek output
...
## Identify Human-Aedes paralogs file
  paralog_file="Human_Aedes-Homologs-Foldseek.csv"
...
while IFS=, read -r group bitscore taxonomy_id organism inparalog_score protein_id protein_name protein_length seed_score af_structure_available; do
